...
Email: [anas.devops@hotmail.com](mailto:anas.devops@hotmail.com) | LinkedIn: [linkedin.com/in/devanasops](https://linkedin.com/in/devanasops) | Remote / Global

---

## Professional Summary
Senior DevOps & Azure Cloud Engineer with 5+ years of experience architecting, securing, and operating enterprise-grade cloud infrastructure across Microsoft Azure, AWS, and GCP. Proven track record leading hybrid-cloud migrations, building multi-stage Azure DevOps and GitHub Actions CI/CD pipelines, managing Kubernetes workloads, and enforcing zero-trust security across multi-client government and commercial environments. Deep expertise in Microsoft Entra ID (Azure AD), Azure Landing Zones, automated SOC2 compliance with AzureProof, and 24/7 site reliability engineering (SRE).

---

## Core Technical Skills
- **Microsoft Azure Enterprise:** Azure Landing Zones, Virtual Networks (VNet), NSGs, Application Gateway, Azure Firewall, Azure Front Door, AKS, App Services, Azure Functions, Azure Key Vault, Microsoft Defender for Cloud, Microsoft Sentinel
- **Identity, Access & Zero-Trust Governance:** Microsoft Entra ID (Azure AD), Conditional Access Policies, Privileged Identity Management (PIM), Managed Identities, Granular RBAC, Zero-Trust Architecture
- **Multi-Cloud & Virtualization:** Microsoft Azure (Primary), Amazon Web Services (AWS), Google Cloud Platform (GCP), Hetzner Cloud, VMware ESXi (Physical Servers), Proxmox VE, Bare Metal
...
- **Containers & Orchestration:** Kubernetes (AKS, K3s, K3d), Docker, Docker Compose, K9s CLI, Kubernetes Operators (CloudNativePG, MariaDB-Operator)
- **Monitoring, SRE & Observability:** Azure Monitor, Log Analytics Workspaces, Application Insights, Prometheus & Grafana, ELK Stack, Zabbix, Alertmanager
...
- **Scripting & Languages:** PowerShell, Bash, Python, YAML, Groovy
...
- Own end-to-end Azure cloud infrastructure for the IBHC.ai enterprise platform, managing multi-subscription environments with Entra ID governance, Conditional Access policies, PIM, and granular RBAC across dev, staging, and production tiers.
- Deployed and manage the DGE-Mawaheb demo environment as a Docker Compose service on Azure VMs with automated GitHub Actions CI/CD pipelines, shipping demo releases in under 10 minutes on every main branch push.
- Architected enterprise Azure DevOps release pipelines for DGE-Mawaheb (UAE government initiative), integrating multi-stage build, automated testing, environment-gated approvals, and instant rollback capabilities.
- Implemented centralized full-stack telemetry using Azure Monitor, Log Analytics, and Application Insights, **cutting MTTR by 60%** through proactive alerting rules.
- Enforced continuous SOC2-aligned security posture via **AzureProof** (automated live Azure configuration scanner against control matrices), reducing manual audit preparation overhead from days to hours.
...
- Manage MLOps infrastructure and containerized inference servers for 3 high-profile AI platforms: `aslaschat.ai`, `qudra-tech.ai`, and the `Takafo` sovereign AI initiative (Cognit & Mubadala partnership), sustaining a **99.9% uptime SLA**.
- Led complete zero-downtime Azure migrations and decommission of `core42app` and `mineralenergy.ae` from legacy cPanel environments within a strict 2-week window.
